...
const FIXTURE_VIDEO_PATH = path.join(__dirname, '..', 'integration', 'fixtures', 'sample-speech.mp4');
const FIXTURE_TRANSCRIPT_PATH = path.join(__dirname, '..', 'integration', 'fixtures', 'sample-speech-transcript.json');
