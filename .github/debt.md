...
|------|------|----------|-------------|--------|
| 2026-02-13 | src/__tests__/agents.test.ts:573-584 | low | Weak test for brand integration - only verifies agent initializes without throwing, doesn't validate brand config is used in system prompt | open |
