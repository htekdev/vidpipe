...
║                                                                               ║
║   ┌─────────────────────────────────────────────────────────────────┐       ║
║   │  🎬 Drop a video → 🤖 AI Processing → 📦 Complete Content Suite │       ║
║   └─────────────────────────────────────────────────────────────────┘       ║
║                                                                               ║
║   📹 Video In  ──▶  🎙️ Transcribe  ──▶  ✂️ Smart Edit  ──▶  📱 Social Posts ║
║                                                                               ║
╚═══════════════════════════════════════════════════════════════════════════════╝
```
...
**An AI-powered CLI pipeline that transforms video recordings into rich, structured content**

*Powered by [GitHub Copilot SDK](https://github.com/github/copilot-sdk) and OpenAI Whisper*
...
╭──────────────────────────────────────────────────────────────────╮
│                                                                  │
│  🎯 14-Stage Pipeline  │  🤖 AI Agents  │  📹 Smart Processing  │
│                                                                  │
╰──────────────────────────────────────────────────────────────────╯
```
...
│  1️⃣  Install  →  2️⃣  Configure  →  3️⃣  Process           │
└─────────────────────────────────────────────────────────────┘
```
...
╠══════════════════════════════════════════════════════════════════════════╣
║                                                                          ║
║  📥 Ingest  →  🎙️ Transcribe  →  🔇 Remove Silence  →  💬 Captions   ║
║       ↓                                                                  ║
║  ✂️ Shorts  →  🎞️ Medium Clips  →  📑 Chapters  →  📝 Summary        ║
║       ↓                                                                  ║
║  📱 Social Posts  →  📰 Blog  →  🚀 Git Push                          ║
║                                                                          ║
╚══════════════════════════════════════════════════════════════════════════╝
```
...
```
╔════════════════════════════════════════════════════════════════╗
║            AI AGENT ARCHITECTURE (Copilot SDK)                 ║
╠════════════════════════════════════════════════════════════════╣
║                                                                ║
║                      BaseAgent (abstract)                      ║
║                             │                                  ║
║           ┌─────────────────┼─────────────────┐                ║
║           │                 │                 │                ║
║      SilenceRemoval    SummaryAgent     ShortsAgent            ║
║           │                 │                 │                ║
║      MediumVideo       ChapterAgent    SocialMedia             ║
║           │                                   │                ║
║      BlogAgent                                                 ║
║                                                                ║
╚════════════════════════════════════════════════════════════════╝
...
╔═══════════════════════════════════════════════════════════╗
║                                                           ║
║              Made with ❤️ by the VidPipe Team             ║
║                                                           ║
║                    ISC License © htekdev                  ║
║                                                           ║
...
**[🌟 Star on GitHub](https://github.com/htekdev/vidpipe)** · **[📖 Documentation](./docs/)** · **[🐛 Report Bug](https://github.com/htekdev/vidpipe/issues)** · **[💡 Request Feature](https://github.com/htekdev/vidpipe/issues)**
